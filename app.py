...
def enviar_mensajes(tiempo_carga, tiempo_click, tiempo_envio, tiempo_cerrar, click_x, click_y, mensaje):
    ...
    for i in range(len(data)):
        ...
        mensaje = mensaje.replace("{nombre}", nombre).replace("{genero}", genero)
